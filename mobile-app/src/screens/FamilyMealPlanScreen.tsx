...
const styles = StyleSheet.create({
  container:{flex:1,backgroundColor:'#F5F7FB'}, header:{height:58,flexDirection:'row',alignItems:'center',paddingHorizontal:spacing.md,backgroundColor:colors.surface,borderBottomWidth:StyleSheet.hairlineWidth,borderBottomColor:colors.border}, iconButton:{width:40,height:40,alignItems:'center',justifyContent:'center'}, headerActions:{width:80,flexDirection:'row',justifyContent:'flex-end'}, headerText:{flex:1,alignItems:'center',marginLeft:40}, title:{fontSize:18,lineHeight:24,fontWeight:'700',color:colors.textPrimary}, subtitle:{fontSize:10,lineHeight:14,color:colors.textSecondary},
